package i.krishnasony.aichat.Adapter;
...
import i.krishnasony.aichat.Models.ChatModel;
import i.krishnasony.aichat.R;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(view == null)
        {
            if(list_chat_models.get(position).isSend)
                view = layoutInflater.inflate(R.layout.list_item_sned_message,null);
            else
                view = layoutInflater.inflate(R.layout.list_item_recieved_message,null);
